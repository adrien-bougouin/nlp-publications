...
\label{sec:introduction}
  ...
  Dans cet article, nous nous plaçons dans le contexte de l'extraction de
  ...
  documents en réduisant l'ensemble des termes-clés candidats à ceux les plus
  spécifiques~\cite{kim2009termextraction} ou en tenant compte de la structure
  des documents pour extraire les termes-clés apparaissant dans les sections les
  plus favorables~\cite{nguyen2007keadocumentstructure,hofmann2009impactofdocumentstructure}.
  ...
  (section~\ref{sec:extraction_automatique_de_termes_cles}) pour observer la
  performance de l'extraction de termes-clés en domaine de spécialité et en
  déduire une échelle de difficulté disciplinaire
  (section~\ref{sec:experiences}). Enfin, nous proposons une analyse des
  résultats afin de déterminer quels sont les causes d'une difficulté accrue
  dans un domaine plus que dans un autre (section~\ref{sec:discussion}).
