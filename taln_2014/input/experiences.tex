...
\label{sec:experiences}
  ...
  \label{subsec:resultats}
    ...
    $\{1..3\}$-grammes, soit des syntagmes nominaux soit des candidats termes.
    %
    Nous distinguons effectivement une différence de difficulté pour
    l'extraction de termes-clés dans les différentes disciplines. L'Archéologie
    ...
    l'Information. Nous observons aussi que, dans le cas de TopicRank, la
