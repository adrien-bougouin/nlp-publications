...
\begin{document}
  ...
  \resume{
    ...
    documents. De ce fait, nous nous intéressons à la tâche d'extraction
    automatique de termes-clés et, plus particulièrement, à la difficulté de
    cette tâche lors du traitement de documents de disciplines scientifiques. Au
    moyen de cinq corpus représentant cinq disciplines différentes (Archéologie,
    Sciences de l'Information, Linguistique, Psychologie, Chimie), nous
