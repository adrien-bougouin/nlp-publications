...
\begin{document}
  ...
  \resume{
    ...
    Cependant, la quantité des documents à traiter étant de plus en plus
    ...
    analysons les facteurs qui augmentent ou réduisent la difficulté de la tâche
  ...
  \abstract{
    ...
    difficulty of the automatique keyphrase extraction from scientific papers
