...
\label{sec:evaluation}
  ...
  \label{subsec:keyphrase_extraction}
    ...
    \label{subsubsec:candidate_extraction_result_analysis}
      ...
      the one of~\newcite{kim2010semeval}, which works better on long documents
...
\label{sec:related_work}
  ...
  and by \newcite{wang2014keyphraseextractionpreprocessing}.

  In their work on automatic keyphrase extraction evaluation,
  \newcite{zesch2009rprecision} proposed a new evaluation measure and applied it
  ...
  \newcite{wang2014keyphraseextractionpreprocessing} have the same conviction
