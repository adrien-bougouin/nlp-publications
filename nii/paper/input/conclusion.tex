...
%  This work showed that clusters of topics ranked by importance can improve the
%  performance of supervised methods. In future work, we plan to work on
%  TopicRank's clustering and to explore topic labelling
