  ...
  \label{subsec:keyphrase_analysis}
    ...
    \begin{table}[b]
      ...
      \begin{tabular}{r|lllll}
        ...
        & \verb:A: & \verb:Nc: & & & \textit{``turbulent summer''}\\ % AP880409-0015
        ...
        & \verb:Nc: & \verb:A: & & & \textit{``anthropologie réflexive'' (``reflexive anthropology'')}\\ % as_2004_011288ar
...
%  the document.
  ...
  information about the noun phrase they modify (e.g.~\TODO{Example}). According
  ...
  \TODO{Discuss the suitability over both defined properties.}
...
%      candidates.
      ...
      \TODO{New method: patterns + linguistic ressources}
    ...
    \label{subsubsec:candidate_extraction_result_analysis}
      ...
      extracting the longest NPs and the NP-chunks.%, followed by candidate terms.
      \TODO{Add our method to the analysis}
      \begin{table}
        \centering
...
%  better performance whith candidate terms as keyphrase candidates.
  ...
  \TODO{We also presented a new candidate extraction method}
