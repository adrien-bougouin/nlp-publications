...
\label{sec:section}
  ...
  We then propose a new approach that selects refined noun phrases by filtering out irrelevant adjective modifiers from the longest sequences of noun and adjectives.
  We demonstrate the effectiveness of our approach by comparing the performance of state-of-the-art supervised and unsupervised keyphrase extraction methods on three standard datasets of different languages and domains.
...
\label{sec:definition_of_candidate_keyphrases}
  ...
  \label{subsec:keyphrase_analysis}
    ...
    important to note the usage of relational adjectives (e.g.~``annual'').
    ...
    \begin{property}\label{prop:noun_phrases}
      ...
      adjective (e.g.~``\underline{annual} hurricane forecast'').
    \end{property}
...
\label{sec:evaluation}
  ...
  \label{subsec:keyphrase_extraction}
    ...
    \label{subsubsec:candidate_extraction_result_analysis}
      ...
      candidate selection method. \TODO{Expliquer les faibles scores (en
      utilisant les compétitions)}
      \begin{table}
        \centering
