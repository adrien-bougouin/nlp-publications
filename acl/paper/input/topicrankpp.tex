...
\label{sec:topicrankpp}
  ...
  \begin{figure*}
    ...
    \begin{tikzpicture}[transform shape, scale=.66]
      ...
      \draw [dashed] (document_node5) -- (domain_node5);
      \draw [dashed] (document_node5) -- (domain_node3);
      \draw [dashed] (document_node1) -- (domain_node1);
      \draw [dashed] (document_node4) -- (domain_node4);
