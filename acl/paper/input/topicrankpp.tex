...
\label{sec:topicrankpp}
  ...
  \begin{figure*}
    ...
    \begin{tikzpicture}[transform shape, scale=.66]
      ...
      % extra link
      \path [<->, dashed] (document_node2) edge (domain_node5);
      \path [<->, dashed] (document_node6) edge (domain_node5);
      \draw [<->, dashed] (document_node6) edge (domain_node3);
      \draw [<->, dashed] (document_node4) edge (domain_node1);
      \draw [<->, dashed] (document_node3) edge (domain_node4);
    \end{tikzpicture}
