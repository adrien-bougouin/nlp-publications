...
\label{sec:etat_de_l_art}
  ...
  \label{subsec:extraction_de_termes_cles_candidats}
    ...
    \TODO{Exemple de chunks nominaux}
    ...
    \TODO{Exemple de plus longues séquences de noms et adjectifs}
  ...
  \label{subsec:ordonnancement_des_termes_cles_candidats}
    ...
    études menées par \newcite{mihalcea2004textrank} et par
    \newcite{wan2008expandrank}, avec des documents de natures différentes,
