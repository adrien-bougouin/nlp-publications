...
\label{sec:evaluation}
  ...
  \label{subsec:cadre_experimental}
    ...
    \label{subsubsec:donnees_de_test}
      ...
      \newcite{wan2008expandrank}. Nous utilisons ces 308 documents pour
  ...
  \label{subsection:configuration_empirique_de_topicrank}
    ...
    expériences durant lesquels nous faisons varier, dans un premier temps, le
  ...
  \label{subsec:parametrage_empirique_de_singlerank}
    ...
    SingleRank lorsque nous faisons varier la fenêtre de cooccurrence de deux à
