...
\label{sec:conclusion_et_perspectives}
  ...
  linguistiquement. \TODO{perspectives sur la selection des candidats (termes
  complexes, etc.)}
  ...
  positifs (\TODO{attention aux exemples bidons}par exemple, \og \underline{empir}e~\fg\ et
