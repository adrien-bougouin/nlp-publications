...
\label{sec:extraction_de_termes_cles_avec_topicrank}
  ...
  \label{subsec:identification_des_sujets}
    ...
    grouper les candidats qui varient uniquement en terme de flexion ou de
    ...
    \newcite{porter1980suffixstripping} (p. ex. les mots \og{}empire\fg{} et
    ...
    que les n-grammes, il semble par exemple plus pertinent d'utiliser la
  ...
  \label{subsec:selection_des_termes_cles}
    ...
    \begin{itemize}
      ...
      \item{le centroïde~: le terme-clé candidat sélectionné pour un sujet est
            ...
            l'équation~\ref{equa:jaccard} page~\pageref{equa:jaccard}).}
    \end{itemize}
