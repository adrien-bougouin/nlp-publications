...
%    \end{table}
    ...
    résultats qui pouraient être obtenus avec une stratégie qui serait capable
    de sélectionner un candidats positif par sujet (s'il y en a un). Nous
    n'avons actuellement pas de telle stratégie, mais les résultats de cette
    borne haute sont très encourageant pour les futurs travaux.
