...
\label{sec:extraction_de_termes_cles_avec_topicrank}
  ...
  \label{subsec:identification_des_sujets}
    ...
    choisissons de suivre \newcite{wan2008expandrank} et
    \newcite{hassan2010conundrums}. Nous extrayont les plus longues séquences de
  ...
  correcte et huit termes-clés sur les dix extraits sont des termes-clés de
  référence.
  \begin{figure}
    \centering
    \begin{tikzpicture}
