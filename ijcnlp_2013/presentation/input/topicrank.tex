    ...
    \begin{columns}
      \begin{column}{.44\textwidth}
        \begin{enumerate}
          ...
          \alt<2,3>{
            \item[$\Rightarrow$]{\footnotesize \hyperlink{candidate_extraction_backup}{$(\text{NOUN} | \text{ADJ})^+$}
                                 \tikz[remember picture, overlay]{\node[coordinate, xshift=-3.5em, yshift=1em](pattern_head){};
                                 \node[coordinate, yshift=5em](pattern_tail){};
                                 \draw<3>[->, thick, red] (pattern_tail) node [yshift=.5em] {\textbf{no linguistic knowledge}} -- (pattern_head);}}
            \item<4->{Candidate clustering}
          }{
            \item<4->{Candidate clustering}
          }\alt<4,5>{
            \item[$\Rightarrow$]{\small \hyperlink{candidate_clustering_backup}{Hierarchical clustering}}
            \item<6->{Graph construction}
          }{
            \item<6->{Graph construction}
          }\alt<6>{
            \item[$\Rightarrow$]{\small \hyperlink{graph_construction_backup}{Complete graph}}
            \item<7->{Topic ranking}
          }{
            \item<7->{Topic ranking}
          }\alt<7>{
          \item[$\Rightarrow$]{\small \hyperlink{topic_ranking_backup}{PageRank's scoring}}
            \item<8->{Keyphrase selection}
          }{
            \item<8->{Keyphrase selection}
            \alt<2->{
            }{
            ...
            \item[$\Rightarrow$]{\small First appearing one}
            \item[]{}
          }{
            \item[]{}
          }
              ...
              \alt<6->{ %next slides
                \alt<8->{ % next slides
                  \alt<18->{ % next slides
                    ...
                    \resizebox{\linewidth}{!}{
                      \begin{tabular}{ccl}
                        ...
                        & & \alt<10->{\textcolor{red}{research libraries}}{research libraries}; libraries\\
                        02 & \multirow{1}{*}{C03} & publishing scene; \alt<12->{\textcolor{red}{scholarly publishing}}{scholarly publishing};\\
                        & & publisher\\
                        03 & C02 & \alt<14->{\textcolor{red}{project euclid}}{project euclid}; project such\\
                        04 & C04 & \alt<16->{\textcolor{red}{role}}{role}; new role\\
                        05 & C16 & \alt<17->{\textcolor{red}{creation}}{creation}\\
                        06 & C06 & \alt<17->{\textcolor{red}{scholarly communication}}{scholarly communication}\\
                        07 & C09 & \alt<17->{\textcolor{red}{mathematics}}{mathematics}\\
                        08 & C12 & \alt<17->{\textcolor{red}{specific aspects}}{specific aspects}\\
                        09 & C10 & \alt<17->{\textcolor{red}{joint electronic journal publishing initiative}}{joint electronic journal publishing initiative}\\
                        10 & C08 & \alt<17->{\textcolor{red}{partnerships}}{partnerships}\\
                        \dots & \dots\\
                        \bottomrule
                      \end{tabular}
                    }
                  ...
                  \begin{tikzpicture}[scale=.19,
                    ...
                    \foreach \number/\pos in {1/above,2/above,3/above,4/above,5/above,6/above,7/above,8/above,9/above,10/above,11/below,12/below,13/below,14/below,15/below,16/below,17/below,18/below,19/below}{
                      ...
                      \ifthenelse{\number > 9}{
                        \node[main node, label={\pos:\Large\textbf{\visible<7->{\textcolor{red}{\pagerank{\number}}}}}] (N-\number) at (\the\mycount:15cm) {C\number};
                      }{
                    ...
                    \coordinate[remember picture, overlay, xshift=-45em, yshift=-11em] (pagerank_coordinates) at (N-13);
                    \node<7>[remember picture, overlay] (pagerank) at (pagerank_coordinates) {\fontsize{45}{30}\selectfont $\textbf{score}(C_i) = (1 - \lambda) + \lambda \times \sum_{C_j \neq C_i} \frac{\textbf{weight}(C_j, C_i) \times \textbf{score}(C_j)}{\mathlarger{\sum}_{C_k \neq C_j} \textbf{weight}(C_j, C_k)}$};
                    \path<7>[remember picture, overlay, ->, thick, red] (pagerank.north east) edge (N-13);
                    \path<7>[remember picture, overlay, ->, thick, red] (pagerank.north east) edge (N-14);
                    \visible<6>{\path[red] (N-11) edge node [left] {\Huge\textbf{offset}\\\Huge\textbf{position}\\\Huge\textbf{weighting}} (N-12);}
                      \foreach \number/\pos in {1/above,2/above,3/above,4/above,5/above,6/above,7/above,8/above,9/above,10/above,11/below,12/below,13/below,14/below,15/below,16/below,17/below,18/below,19/below}{
                        \mycount=\number
                        \advance\mycount by -1
                        \multiply\mycount by 19
                ...
                \resizebox{\linewidth}{!}{
                  \begin{tabular}{cl}
                    ...
                    & publisher\\
                    C04 & role; new role \textcolor{red}{$\longleftarrow \text{stem overlap} \geq \frac{1}{4}$\tikz[remember picture, overlay]{\node[coordinate, xshift=-5em, yshift=1em] (stem_overlap_head) {};\node[coordinate, xshift=-27.5em, yshift=5em] (stem_overlap_tail) {};\draw<5>[->,  ultra thick, red] (stem_overlap_tail) node [yshift=.5em] {\textbf{\large naive topic similarity}} -- (stem_overlap_head);}}\\
                    C05 & important\\
