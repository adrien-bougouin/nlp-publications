...
\label{sec:introduction}
  ...
  To evaluate TopicRank, we followed~\newcite{hassan2010conundrums} who stated
  that multiple datasets must be used to evaluate and fully understand the
  strengths and weaknesses of a method. We used four evaluation datasets of
  different languages, document sizes and domains, and compared the keyphrases
...
\label{sec:related_work}
  ...
  \newcite{tsatsaronis2010semanticrank} propose to connect vertices using
...
\label{sec:experimental_settings}
  ...
  \label{subsec:datasets}
    ...
    annotations of each documents and removed the lexical redundancies. All of
  ...
  \label{subsec:baselines}
    ...
    because the evaluation is performed with stemmed forms, which mean that
