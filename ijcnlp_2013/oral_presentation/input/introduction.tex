    ...
    \visible<2>{
      \begin{textblock*}{.95\textwidth}(.025\textwidth, -.1\textheight)
        ...
        \begin{exampleblock}{\footnotesize \textcolor{red}{Project Euclid} and
          ...
          \scriptsize Project Euclid, a \textcolor{red}{joint electronic journal
          publishing initiative} of \textcolor{red}{Cornell University Library}
          and \textcolor{red}{Duke University Press} is discussed in the broader
          contexts of the changing patterns of \textcolor{red}{scholarly
          communication} and the publishing scene of
