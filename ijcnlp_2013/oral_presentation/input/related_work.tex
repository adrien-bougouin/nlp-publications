      ...
      \begin{columns}
        \begin{column}{.6\textwidth}
          ...
          \begin{tikzpicture}[thin,
            ...
            \path[JungleGreen] (university) edge node {\textcolor{black}{1}} (library);
            \path[JungleGreen] (university) edge node {\textcolor{black}{1}} (duke);
            \path[JungleGreen] (university) edge node {\textcolor{black}{1}} (press);
            \path[JungleGreen] (university) edge node {\textcolor{black}{1}} (cornell);

            % connected component
            \node[main node] (further) [left=of university.south west] {further};
            \node[main node] (skills) [below=of further.south west] {skills};

            \path[JungleGreen] (skills) edge node {\textcolor{black}{1}} (further);
            ...
            \path[JungleGreen] (communication) edge node {\textcolor{black}{1}} (scholarly);
            \path[JungleGreen] (publishing) edge node {\textcolor{black}{1}} (scholarly);
            \path[JungleGreen] (publishing) edge node {\textcolor{black}{1}} (scene);
            \path[JungleGreen] (publishing) edge node {\textcolor{black}{1}} (journal);
            \path[JungleGreen] (publishing) edge node {\textcolor{black}{1}} (initiative);
            \path[JungleGreen] (journal) edge node {\textcolor{black}{1}} (electronic);
            \path[JungleGreen] (joint) edge node {\textcolor{black}{1}} (electronic);

            % connected component
            \node[main node] (new) [below=of skills.south] {new};
            \node[main node] (role) [below=of new.south east] {role};

            \path[JungleGreen] (new) edge node {\textcolor{black}{1}} (role);
            ...
            \path[JungleGreen] (digital) edge node {\textcolor{black}{1}} (libraries);
            \path[JungleGreen] (libraries) edge node {\textcolor{black}{1}} (research);
            ...
            \path[JungleGreen] (relevant) edge node {\textcolor{black}{1}} (experience);

            % connected component
            \node[main node] (model) [below=of digital.south east] {model};
            \node[main node] (economic) [below right=of model.south east] {economic};

            \path[JungleGreen] (model) edge node {\textcolor{black}{1}} (economic);
            ...
            \path[JungleGreen] (specific) edge node {\textcolor{black}{1}} (aspects);

            % connected component
            \node[main node] (life) [below right=of economic.south east] {life};
            \node[main node] (cycle) [right=of life.north east] {cycle};

            \path[JungleGreen] (life) edge node {\textcolor{black}{1}} (cycle);
            ...
            \path[JungleGreen] (euclid) edge node {\textcolor{black}{1}} (project);
            \path[JungleGreen] (project) edge node {\textcolor{black}{1}} (such);
          \end{tikzpicture}
        \end{column}
