    ...
    \begin{columns}
      \begin{column}{.45\textwidth}
        \begin{enumerate}
          ...
          \alt<2>{
            \item[$\Rightarrow$]{\small $(\text{NOUN} | \text{ADJ})^*$}
          }{
            \item<3->{Candidate clustering}
          }\alt<3>{
            \item[$\Rightarrow$]{\small Hierarchical clustering}
          }{
            \item<4->{Graph creation}
          }\alt<4>{
            \item[$\Rightarrow$]{\small Connected graph}
          }{
            \item<5->{Topic ranking}
          }\alt<5>{
            \item[$\Rightarrow$]{\small PageRank's random walk}
          }{
            \item<6->{Keyphrase selection}
          }
          \item<6->[$\Rightarrow$]{\small First appearing candidate}
        \end{enumerate}
        ...
        \visible<11>{
          \begin{textblock*}{.95\textwidth}(.025\textwidth, -.45\textheight)
            \setbeamertemplate{blocks}[rounded][shadow=true]
        ...
        \visible<13>{
          \begin{textblock*}{.95\textwidth}(.025\textwidth, -.5\textheight)
            \setbeamertemplate{blocks}[rounded][shadow=true]
