...
\label{sec:section}
  ...
  \TODO{Explain more deeply and provide more citations}. However, no previous
...
\label{sec:definition_of_candidate_keyphrases}
  ...
  \label{subsec:keyphrase_analysis}
    ...
    degree \TODO{denomination?}. Second, the keyphrases are presented regarding
    ...
    \TODO{Replace "in French" or "in English" by "from ... datasets"}
...
\label{sec:candidate_extraction}
  ...
  limited adaptation to different languages \TODO{Rewrite taking into account
  the reviews}.
  ...
  keyphrases from  a set of terminological phrases \TODO{Change what's next and
  add citations, as required by reviewers}.Besides, extracting
...
\label{sec:evaluation}
  ...
  \label{subsec:candidate_extraction}
    ...
    \label{subsubsec:method_settings}
      ...
      basic patterns are used: \TODO{Béatrice disagree}
      \begin{itemize}
...
%    \end{table*}
    ...
    \end{table*}
      ...
      We observe that the TermSuite candidates' quality is not stable over the
...
\label{sec:conclusion}
  ...
  we inferred two general keyphrase properties \TODO{Rappel des propriétés}.
  ...
  better performance whith term candidates. \TODO{Mieux lier ce qui suit au
  reste.} As for the third method, TopicRank, we can try to improve the results
  ...
  new keyphrase properties or see which methods could be combined. \TODO{Also a
  domain analysis \dots}
