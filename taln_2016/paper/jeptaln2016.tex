...
\begin{document}
  ...
  \resume{
    ...
    réalisée par les documentalistes de bibliothèques numériques. Après analyse
    ...
    (hybride) libre et contrôlée. Notre méthode à la rare capacité à
    fournir des termes-clés ne se trouvant pas nécessairement dans le document.
    Par ailleurs, nos expériences montrent une amélioration significative
    vis-à-vis de l'approche à base de graphe classique.
  }
  ...
  \abstract{Unified document and domain-specific model for keyphrase extraction
    ...
    professional indexers. From an analysis of indexers of the Institute
    for Scientific and Technical Information (INIST) working at Digital
    ...
    extraction and assignment (free and controlled indexing). Apart from begin
    able to assign keyphrases that do not necessarily appear within documents,
    our experiments shows that our approach outperforms state-of-the-art
