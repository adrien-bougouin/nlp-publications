\begin{figure} % archeologie_525-02-11060
  ...
  \framebox[\linewidth]{
    \parbox{.99\linewidth}{\footnotesize
      \textbf{Sortie de notre méthode~:} \underline{céramique}~;
  ...
  \caption[
    Exemple d'extraction de termes-clés avec notre méthode.
  ]{
    Exemple d'extraction de termes-clés avec notre méthode sur le résumé d'une
    notice d'un artice d'archéologie. Les termes-clés soulignés sont les
