...
\newcommand\chaptercite[2]{\setlength{\epigraphwidth}{0.8\textwidth}\epigraph{\justifying{\Large``}\textit{#1}{\Large''}}{--- #2}}
\newcommand\smallchaptercite[2]{\setlength{\epigraphwidth}{0.8\textwidth}\epigraph{\hfill{}{\Large``}\textit{#1}{\Large''}}{--- #2}}
