...
\newcommand\chaptercite[2]{\setlength{\epigraphwidth}{0.667\textwidth}\epigraph{\justifying{\Large``}\textit{#1}{\Large''}}{--- #2}}
\newcommand\smallchaptercite[2]{\setlength{\epigraphwidth}{0.667\textwidth}\epigraph{\hfill{}{\Large``}\textit{#1}{\Large''}}{--- #2}}
\newcommand\thesisquote[2]{\setlength{\epigraphwidth}{0.5\textwidth}\epigraph{\justifying{\Large``}\textit{#1}{\Large''}}{--- #2}}
...
%  %\input{input/introductions_and_conclusions_only.tex}
