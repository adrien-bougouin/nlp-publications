...
\begin{document}
  ...
  \input{input/introduction_indexed.tex}
  \input{input/state_of_the_art_indexed.tex}
  \input{input/resources_indexed.tex}
  \input{input/domain_independent_keyphrase_extraction_indexed.tex}
  \input{input/domain_specific_keyphrase_annotation_indexed.tex}
  \input{input/conclusion_indexed.tex}
