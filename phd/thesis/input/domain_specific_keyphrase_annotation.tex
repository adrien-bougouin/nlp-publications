...
\label{chap:main-domain_specific_keyphrase_annotation}
  ...
  \label{sec:main:domain_specific_keyphrase_annotation-introduction}
    ...
    contrôlé du domaine. Ce vocabulaire contrôlé n'existant cependant pas
    toujours, nous en déterminons une sous-partie à partir des termes-clés de
    référence des données d'entraînement.
  ...
  \label{sec:main-domain_specific_keyphrase_annotation-manual_keyphrase_annotation}
    En nous fondant sur les  propos recueillis des indexeurs professionnels de
    l'Inist, qui maintient une partie des bases de données bibliographiques de
    la \textsc{Bsn} (bibliothèque scientifique numérique), nous présentons la
    méthodologie d'indexation manuelle en domaines de spécialités.
  ...
  \label{sec:main-domain_specific_keyphrase_annotation-manual_evaluation}
    ...
    \REMARK{Faut-il que je précise que cette section présentera l'évaluation sur
    les quatre corpus Termith et aussi l'évaluation de TopicCoRank dans la
