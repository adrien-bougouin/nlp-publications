...
\label{chap:main-data_description}
  ...
  \label{sec:main-data_description-introduction}
    ...
    etc.) et trois genres de documents (résumé, articles scientifiques et
    ...
    \begin{table}[!h]
      ...
      \resizebox{\linewidth}{!}{
        \begin{tabular}{l|c@{~~}c@{~~}c@{~~}c|c@{~~}c@{~~}c@{~~}c}
          ...
          \hline
          Sciences de l'infor- & & & & & & &\\
          mation\hfill{}Appr. & Français & Scientifique (résumé) & 506 & & & &\\
...
%      }
  ...
  \label{sec:main-data_description-conclusion}
    ...
    caractéristiques qu'il nous intéressent de voir varier sont le genre
    ...
    \begin{table}[!h]
      ...
      \resizebox{\linewidth}{!}{
        \begin{tabular}{r@{~~}l|c@{~~}c@{~~}c@{~~}c|c@{~~}c@{~~}c@{~~}c}
          ...
          & & Langue & Genre & Quantité & Mots moy. & Annotateur & Quantité moy. & \og{}À assigner\fg{} & Mots moy.\\
          \hline
          \multirow{4}{*}[-.5em]{\begin{sideways}Termith\end{sideways}} & Linguistique & Français & Scientifique (résumé) & 715 & 156.7 & Professionnel & 8,7 & 61,2~\% & 1,7\\
          & Sciences de l'information & \ditto & \ditto & 706 & & \ditto & &\\
          & Archéologie & \ditto & \ditto & 718 & & \ditto & &\\
          & Chimie & \ditto & \ditto & 782 & & \ditto & &\\
    ...
    nous présentons peuvent servir à inférer des propriétés stables de
    termes-clés. De ces collections, nous pouvons par exemple vérifier les deux
