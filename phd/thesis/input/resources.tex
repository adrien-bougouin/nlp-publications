...
\label{chap:main-data_description}
  ...
  \label{sec:main-data_description-introduction}
    ...
    annotation homogène entre tous les documents d'un même domaine grâce à un
    vocabulaire contrôlé~; les lecteurs sont plus libres que les auteurs et les
    indexeurs professionnels, ils ne sont influencés ni par les termes-clés
    \og{}à la mode\fg{}, ni par un vocabulaire contrôlé.
