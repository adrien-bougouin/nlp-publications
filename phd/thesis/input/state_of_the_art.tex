  ...
  \label{sec:main-state_of_the_art-automatic_keyphrase_extraction}
    ...
    \label{subsec:main-state_of_the_art-automatic_keyphrase_extraction-unsupervised_keyphrase_extraction}
      ...
      \label{subsubsec:main-state_of_the_art-automatic_keyphrase_extraction-unsupervised_keyphrase_extraction-clustering_approaches}
        ...
        \newcite{hassan2010conundrums} ont comparé KeyCluster à \textsc{Tf-Idf}.
        Dans leur expériences, réalisées avec quatre collections de données
        différentes, KeyCluster obtient des performances plus faibles que
        \textsc{Tf-Idf}. \TODO{et donc~???}
      ...
      \label{subsubsec:main-state_of_the_art-automatic_keyphrase_extraction-unsupervised_keyphrase_extraction-graph_based_approaches}
        ...
        globalement pas d'amélioration vis-à-vis de SingleRank (\TODO{tableau
        avec les perf de wan et de hasan}).
...
%        \end{align}
        ...
        \end{itemize}
        Comme pour SingleRank, les termes-clés candidats sont ensuite ordonnés
        d'après le score d'importance des mots qu'ils contiennent.
