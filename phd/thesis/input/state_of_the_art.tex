...
%    are available on-line today have keyphrases.
  ...
  \label{sec:main-state_of_the_art-keyphrase_candidate_selection}
    ...
    nous distinguons deux sous-catégories~: les candidats erronés\index{Candidat
    erronés@Candidat erronés \textit{(irrelevant candidate)}|textbf} et les
    candidats porteurs d'indices\index{Candidat porteur d'indices@Candidat
    porteur d'indices \textit{(clue candidate)}|textbf} pouvant influencer
