...
%      pas les mots.
      ...
      \label{subsubsec:main-automatic_keyphrase_annotation-unsupervised_automatic_keyphrase_extraction-topicrank-topic_identification}
        ...
        pour le groupement que nous effectuons ensuite. \TODO{trop court et pas
      ...
      \label{subsubsec:main-automatic_keyphrase_annotation-unsupervised_automatic_keyphrase_extraction-topicrank-topic_ranking}
        ...
        Les sujets du document composent les n\oe{}uds $N$ du graphe complet $G
        ...
        \newcite{wan2008expandrank}, car les arêtes de poids nul ne sont pas des
      ...
      \label{subsubsec:main-automatic_keyphrase_annotation-unsupervised_automatic_keyphrase_extraction-topicrank-keyphrase_selection}
        ...
        pas fournir les termes-clés les plus précis\TODO{vague}.
...
%          vérifier.
  ...
  \label{sec:main-automatic_keyphrase_annotation-supervised_automatic_keyphrase_extraction}
    \TODO{Reprendre le modèle du premier paragraphe d'introduction de
    l'extraction non supervisée}

    \TODO{Rappel sur les méthodes d'assignement}
    \TODO{Donner l'intuition qu'il faut faire extraction ET assignement}

    \TODO{Nous proposons de faire les deux avec du co-ranking}
    \TODO{En gros nous avons TopicRank pour les cas sans données et TopicCoRank
    pour le autres cas}
    ...
    \label{subsec:main-automatic_keyphrase_annotation-supervised_automatic_keyphrase_annotation-topiccorank}
      ...
      termes-clés. \TODO{Homogénéiser les section de TopicCoRank} \TODO{Mettre
      l'étape construction du graph dans TopicRank pour plus de cohérence~!?!}
