...
\label{chap:main-automatic_keyphrase_annotation}
  ...
  \label{sec:main-automatic_keyphrase_annotation-keyphrase_candidate_selection}
    ...
    \label{subsec:main-automatic_keyphrase_annotation-keyphrase_candidate_selection-analysis_of_keyphrase_properties}
      ...
      \begin{table}[!h]
        ...
        \resizebox{\linewidth}{!}{
          \begin{tabular}{l@{~}l|c@{~~}c@{~~}c@{~~}c|c@{~~}c@{~~}c@{~~}c}
            ...
            $\drsh$ & Appr. & Anglais & Journalistique & 208 &  & Lecteur &  &  & \\
            \bottomrule
          \end{tabular}
        }
      ...
      \TODO{qu'observe-t-on dans le tableau ?} Un adjectif composé est une
      réunion de mots équivalant à un adjectif, nous parlons aussi de locution
      adjectif (par exemple~: \og{}socio-culturel\fg{}). \TODO{et donc ?}.
      \TODO{qu'observe-t-on dans le tableau ?}. Un adjectif qualificatif est un
      ...
      (\TODO{exemple}). \TODO{moyenmoyen}. \TODO{qu'observe-t-on dans le
      tableau~?}.
      \begin{table}[!ht]
        \centering
          \begin{tabular}{l|ccc}
      ...
      \begin{table}[!h]
        ...
        \caption[
          ...
          Pattrons grammaticaux les plus fréquents parmi les termes-clés
          français et anglais. \TODO{mapping des POS}.
          \TODO{resortir avec les adjR et ADjComp}
