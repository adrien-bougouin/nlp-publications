...
\label{part:main-automatic_keyphrase_annotation}
  ...
  \label{chap:main-automatic_keyphrase_annotation-keyphrase_candidate_selection}
    ...
    \label{sec:main-automatic_keyphrase_annotation-keyphrase_candidate_selection-evaluation}
      \subsection{Evaluation intrinsèque}
      \label{subsec:main-automatic_keyphrase_annotation-keyphrase_candidate_selection-evaluation-intrinsic_evaluation}

      \subsection{Evaluation extrinsèque}
      \label{subsec:main-automatic_keyphrase_annotation-keyphrase_candidate_selection-evaluation-extrinsic_evaluation}
  ...
  \label{chap:main-automatic_keyphrase_annotation-unsupervised_automatic_keyphrase_extraction}
    ...
    \label{sec:main-automatic_keyphrase_annotation-unsupervised_automatic_keyphrase_extraction-evaluation}
      ...
      \label{subsec:main-automatic_keyphrase_annotation-unsupervised_automatic_keyphrase_extraction-evaluation-comparison}
  ...
  \label{chap:main-automatic_keyphrase_annotation-supervised_automatic_keyphrase_extraction}
    ...
    \label{sec:main-automatic_keyphrase_annotation-supervised_automatic_keyphrase_annotation-evaluation}
      \subsection{Méthodes de référence}
      \label{subsec:main-automatic_keyphrase_annotation-supervised_automatic_keyphrase_annotation-evaluation-baselines}

      \subsection{Collections de données}
      \label{subsec:main-automatic_keyphrase_annotation-supervised_automatic_keyphrase_annotation-evaluation-evaluation_data}

      \subsection{Prétraitements}
      \label{subsec:main-automatic_keyphrase_annotation-supervised_automatic_keyphrase_annotation-evaluation-preprocessing}
      
      \subsection{Mesures d'évaluation}
      \label{subsec:main-automatic_keyphrase_annotation-supervised_automatic_keyphrase_annotation-evaluation-evaluation_measures}
      
      \subsection{Comparaison de TopicRank++ avec l'existant}
      \label{subsec:main-automatic_keyphrase_annotation-supervised_automatic_keyphrase_annotation-evaluation-comparison}

    \section{Analyse d'erreur}
    \label{sec:main-automatic_keyphrase_annotation-supervised_automatic_keyphrase_annotation-error_analysis}
