...
\label{chap:main-automatic_keyphrase_annotation}
  ...
  \label{sec:main-automatic_keyphrase_annotation-introduction}
    ...
    caractéristiques des données traitées, nous définissons les bases d'un
    ...
    dans le document. Peut de travaux s'intéresse à l'assignement de
    termes-clés. Cette aspect de l'indexation automatique par termes-clés est
    toutefois \TODO{\dots}
