...
\label{chap:main-domain_independent_keyphrase_extraction}
  ...
  \label{sec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection}
    ...
    \label{subsec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection-analysis_of_keyphrase_properties}
      ...
      de propriétés stables des termes-clés. Une approche raisonable peut donc
      se restreindre aux $\{1..3\}$-grammes, à l'instar de
      ...
      modifieurs, comme le verbe au participe passé et l'adverbe sont très
      utilisés. L'usage de ces derniers au sein de termes-clés semble être
      exceptionnel. Les déterminants et prépositions ont un usage presque
      exclusivement français. Ceci s'explique par le fait, qu'en anglais, les
      formes composés (par exemple,  \textit{\og{}nature conservation\fg{}} --
      \og{}conservation de la nature\fg{}) sont préférées aux formes
      syntagmatiques (par exemple~: \textit{\og{}conservation of nature\fg{}}).
      ...
      finement leur nature~: relationnel, composé ou autre (qualificatif).
      \TODO{définir ces catégories d'adjectifs} Pour
