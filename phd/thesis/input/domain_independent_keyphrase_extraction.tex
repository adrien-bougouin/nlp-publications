...
\label{chap:main-domain_independent_keyphrase_extraction}
  ...
  \label{sec:main:domain_independent_keyphrase_extraction-introduction}
    ...
    catégorie d'indexation par termes-clés est celle la plus étudiée de nos
    ...
    suffisamment de candidats, alors la performance optimale pouvant être
    ...
    d'un adjectif apposé à un nom. Nous proposons une méthode qui juge si un
    adjectif apporte du sens bénéfique à la caractérisation du contenu du
    document, auquel cas il est sélectionné avec le nom qu'il modifie, ou non,
    auquel cas seul le nom est sélectionné comme terme-clé candidat.
  ...
  \label{sec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection}
    ...
    \label{subsec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection-analysis_of_keyphrase_properties}
      ...
      étiquetés grammaticalement et manuellement corrigés.
      \begin{table}[!h]
        \centering
    ...
    \label{subsec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection-modifiers_filtering}
      ...
      \label{subsubsec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection-modifiers_filtering-relational_adjective_detection}
    ...
    \label{subsec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection-evaluation}
      ...
      \label{subsubsec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection-evaluation-preprocessing}
