...
\label{chap:main-domain_independent_keyphrase_extraction}
  ...
  \label{sec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection}
    ...
    \label{subsec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection-analysis_of_keyphrase_properties}
      ...
      nature\fg{}). \TODO{explique le "danger" de prendre le P et DET}
          ...
          \subfigure[Archéologie]{
            \begin{tikzpicture}
              ...
              \begin{axis}[axis lines=middle,
                ...
                \draw[thick] ({axis cs:0.70,0}|-{rel axis cs:0,1}) -- ({axis cs:0.70,0}|-{rel axis cs:0,0}) [color=red!66];
                \draw[densely dashed] ({axis cs:0.20,0}|-{rel axis cs:0,1}) -- ({axis cs:0.20,0}|-{rel axis cs:0,0}) [color=black!66];
                \node at (axis cs:0.70,27.5) [color=red!66, anchor=west] {\tiny{0,70}};
                \node at (axis cs:0.20,27.5) [color=black!66, anchor=west] {\tiny{0,20}};
              \end{axis}
            \end{tikzpicture}
          }
          \subfigure[Chimie]{
            \begin{tikzpicture}
              ...
              \begin{axis}[axis lines=middle,
                ...
                \draw[thick] ({axis cs:0.60,0}|-{rel axis cs:0,1}) -- ({axis cs:0.60,0}|-{rel axis cs:0,0}) [color=red!66];
                \draw[densely dashed] ({axis cs:0.20,0}|-{rel axis cs:0,1}) -- ({axis cs:0.20,0}|-{rel axis cs:0,0}) [color=black!66];
                \node at (axis cs:0.60,17.5) [color=red!66, anchor=west] {\tiny{0,60}};
                \node at (axis cs:0.20,17.5) [color=black!66, anchor=west] {\tiny{0,20}};
              \end{axis}
            \end{tikzpicture}
          }
