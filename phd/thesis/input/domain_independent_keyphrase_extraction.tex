...
\label{chap:main-domain_independent_keyphrase_extraction}
  ...
  \label{sec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection}
    ...
    \label{subsec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection-analysis_of_keyphrase_properties}
      ...
      termes-clés qui sont des mots simples sont des noms. }~: nom commun, nom
      ...
      bi-grammes et tri-grammes couvrent plus de 90~\% des termes-clés de références. En
      français, ce sont les uni-grammes qui sont les plus utilisés, suivis par
      les bi-grammes, tandis qu'en anglais, ce sont les bi-grammes qui sont les
      plus employés, avec des proportions équivalentes d'uni-grammes et de
      tri-grammes. Ces premières observations font écho à celles que nous
      trouvons dans la littérature, nous en concluons qu'il s'agit de
      ...
      \TODO{la suite n'est pas fluide}
      ...
      finement sa nature~: relationnel, composé complexe ou autre
      (qualificatif).
      ...
      sert de modificateur au sein des titre de catégories, telles que celles de
      ...
      \og{}socio-éducatif\fg{}). L'adjectif composé complexe indique avec
      précision la place hiérarchique qu'occupe le nom qu'il modifie (par
      exemple, \og{}activité socio-éducative\fg{} est un hyponyme de
      \og{}activité\fg{}). À l'instar de l'adjectif relationnel, il est donc un
      bon modificateur au sein de titres de catégories et, par transitivité, il
      apporte potentiellement du sens bénéfique à la caractérisation  de tout ou
      partie du contenu d'un document.
      ...
      \texttt{[PERTAINYM]} indique que l'adjectif est relationnel. \TODO{WoNef
      est la retranscription française de WordNet BLABLABLA}
      ...
      ~\\Pour détecter les adjectifs composés, nous regardons si l'adjectif
      possède un trait d'union, qui marque la composition en français et en
      anglais. Cette méthode n'est pas exhaustive. En effet, les mots qui
      constituent un adjectif composé complexe peuvent aussi être concaténés sans marque
      graphique ou séparé par un espace. Nous ne considérons pas ces deux
      procédés, parce qu'ils sont moins productifs que l'usage du trait d'union,
      parce qu'ils nécesitent d'adapter les outils de prétraitements
      (segmentation en mots et étiquetage grammatical) et parce que leur
      détection est soumise à ambigüités. \TODO{Ça sent la mauvaise fois}
        ...
        \begin{table}[!h]
          ...
          \resizebox{\linewidth}{!}{
            \begin{tabular}{r|ccc|ccc|ccc|ccc}
              ...
              \cline{2-13}
              & Cand./Doc. & R$_{\text{max}}$ & QR & Cand./Doc. & R$_{\text{max}}$ & QR & Cand./Doc. & R$_{\text{max}}$ & QR & Cand./Doc. & R$_{\text{max}}$ & QR\\
              \hline
    ...
    \label{subsec:main:domain_independent_keyphrase_extraction-keyphrase_candidate_selection-conclusion}
      ...
      \TODO{mettre en perspective une étude plus approfondie des type de
