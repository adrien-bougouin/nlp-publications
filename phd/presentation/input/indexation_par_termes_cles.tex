    ...
    \begin{frame}{Indexation par termes-clés}
      \begin{figure}
        ...
        \begin{tikzpicture}[scale=.35, node distance=3cm]
          ...
          \draw [draw=termithorange, thick, dashed] ($(extraction.north west)+(-.5cm, 5.5cm)$) rectangle ($(extraction.south east)+(.5cm, -5.5cm)$);
          \node [above=of vocabulaire_controle, yshift=-2.9cm] (domaine_de_specialite) {\small Domaines de spécialité};
    ...
    \begin{frame}{Indexation par termes-clés}
      \begin{figure}
        ...
        \begin{tikzpicture}[scale=.35, node distance=3cm]
          ...
          \draw [draw=termithorange, thick, dashed] ($(assignement.north west)+(-1cm, 5.5cm)$) rectangle ($(assignement.south east)+(1cm, -5.5cm)$);
